...
C:\Windows\System32\WindowsPowerShell\v1.0 -Command {Import-Module WebAdministration; Set-ItemProperty 'IIS:\sites\Default Web Site' -Name physicalPath -Value c:\Speakr.TalksApi\publish}
